...
const BottomNav = {
    render() {
        ...
        nav.innerHTML = `<div class="flex items-center justify-around h-16 max-w-lg mx-auto">
            ...
            <button onclick="Router.navigate('ai-chat')" class="flex flex-col items-center justify-center py-1 px-3 relative">
                <svg class="w-6 h-6 ${current === 'ai-chat' ? 'text-primary-500' : 'text-gray-400 dark:text-gray-500'}" fill="${current === 'ai-chat' ? 'currentColor' : 'none'}" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"/></svg>
                ${current === 'ai-chat' ? '<div class="absolute -top-1 w-6 h-1 bg-primary-500 rounded-full"></div>' : ''}
            </button>
